 ...
 * Figure \@ref(fig:compareScenariosBarAll) compares the scenarios in terms of % of levy generated by areas in each IMD decile while Figure \@ref(fig:compareScenariosPlotAll) compares the levy generated under each scenario at LSOA level. In both cases, Scenario 2 should be lower in more deprived areas and higher in less deprived areas. Figure \@ref(fig:compareScenariosBarAllboxPlot) shows whether or not this is the case
...
```
```{r compareScenariosBarAllboxPlot, fig.cap = "Box plot version"}
