...
Table \@ref(tab:summaryLevyResults) shows the summary overall levy value results by Scenario.
...
makeFlexTable(t[, .(`Scenario`, `nLSOAs`, 
                    ...
                    "Electricity emissions levy" = `Electricity`)], cap = paste0("Levy total (Year 1 £m GBP): ", rParams$filter))
...
Table \@ref(tab:summaryRetrofitCostResults) shows the summary overall retrofit cost results.
