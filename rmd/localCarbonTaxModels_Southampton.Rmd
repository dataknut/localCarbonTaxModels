...
boundaries$lsoa_soton <- filter(boundaries$lsoa_solent, 
                                LAD11NM == "Southampton")
...
Plots & maps of emissions after conversion to per dwelling using the number of electricity meters.

```{r imputePerDwellingEmissions}
