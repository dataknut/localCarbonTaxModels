...
# Emissions Levy Case Study - Southampton
...
sf <- merge(boundaries$lsoa_soton_leaflet, data$lsoa_lookup_solent[, .(LSOA11CD, WD20CD, WD20NM)],
                                       by = "LSOA11CD")
...
t <- table(data$lsoa_imd2019_soton$IMD_Decile_label) 
t
prop.table(t)

# check 50% most deprived
data$lsoa_imd2019_soton[, IMD_50pc := ifelse(IMD_Decile < 6,
                                             "50% most deprived",
                                             "50% least deprived")]

t <- table(data$lsoa_imd2019_soton$IMD_50pc) 
t
prop.table(t)
```
...
sf <- merge(boundaries$lsoa_soton_leaflet, data$lsoa_imd2019_soton[, .(LSOA11CD= lsoa11cd, IMDScore, IMD_Decile,IMD_Decile_label)],
                                       by = "LSOA11CD")
...
ggplot2::ggsave(filename = here::here("plots/compareScenarios_beis_GBP_propTotalByIMD.png"))
...
ggplot2::ggsave(filename = here::here("plots/compareScenarios_beis_GBPtotal_perLSOA_scatter.png"))
```
...
ggplot2::ggsave(filename = here::here("plots/compareScenarios_beis_GBPgas_perLSOA_scatter.png"))
```
...
ggplot2::ggsave(filename = here::here("plots/compareScenarios_beis_GBPelec_perLSOA_scatter.png"))
```
...
ggplot2::ggsave(filename = here::here("plots/whoWins_RetrofitCost_beis_GBPtotal_sc1.png"))
...
ggplot2::ggsave(filename = here::here("plots/whoWins_RetrofitCost_beis_GBPtotal_sc1_energy.png"))
```
...
ggplot2::ggsave(filename = here::here("plots/whoWins_RetrofitCost_beis_GBPtotal_sc1_perdw.png"))
...
ggplot2::ggsave(filename = here::here("plots/whoWins_RetrofitCost_beis_GBPtotal_energy_sc1_perdw.png"))
```
...
ggplot2::ggsave(filename = here::here("plots/whoWins_RetrofitCost_beis_GBPtotal_sc2.png"))
...
ggplot2::ggsave(filename = here::here("plots/whoWins_yearsRequiredToPayRetrofit_beis_GBPtotal_sc1_perdw.png"))
...
ggplot2::ggsave(filename = here::here("plots/whoWins_yearsRequiredToPayRetrofit_beis_GBPtotal_energy_sc1_perdw.png"))
...
ggplot2::ggsave(filename = here::here("plots/transferVis_allEmissions_sc1.png"))
...
ggplot2::ggplot(plotDT, aes(x = reorder(LSOA11CD, -retrofitSum), colour = WD18NM,
  ...
  labs(x = "LSOAs (ordered by retrofit cost)",
       y = "Year 1 surplus (£M)",
       caption = "BEIS central carbon cost, all emissions levy")
ggplot2::ggsave(filename = here::here("plots/surplusVis_allEmissions_sc1.png"))
...
ggplot2::ggsave(filename = here::here("plots/transferVis_energyEmissions_sc1.png"))
...
ggplot2::ggplot(plotDT, aes(x = reorder(LSOA11CD, -retrofitSum), colour = WD18NM,
  ...
  labs(x = "LSOAs (ordered by retrofit cost)",
       y = "Year 1 surplus (£M)",
       caption = "BEIS central carbon cost, energy emissions levy")
ggplot2::ggsave(filename = here::here("plots/surplusVis_energyEmissions_sc1.png"))
...
ggplot2::ggplot(credsLsoaDT, aes(x = IMDScore, 
  ...
  labs(y = "Years to pay off",
       caption = "BEIS central carbon cost, all emissions levy")
ggplot2::ggsave(filename = here::here("plots/whoWins_yearsRequiredToPayRetrofit_beis_GBPtotal_sc2_perdw.png"))
...
ggplot2::ggplot(credsLsoaDT, aes(x = IMDScore, 
  ...
  labs(y = "Years to pay off",
       caption = "BEIS central carbon cost, gas emissions levy\n(excludes LSOA with 0 gas)")
ggplot2::ggsave(filename = here::here("plots/whoWins_yearsRequiredToPayRetrofit_beis_GBPtotal_energy_sc2_perdw.png"))
...
ggplot2::ggsave(filename = here::here("plots/transferVis_allEmissions_sc2.png"))
